...
if __name__ == '__main__':
    for number in numbers:
        ...
        r_distance = list(get_r_distance(beat))[1:]

        beat_count = Counter(beat)
        # print('--------------', number, '------------')
        # print('mit bih', number,'beat_count', beat_count)
        # print('r dist', len(r_distance))
